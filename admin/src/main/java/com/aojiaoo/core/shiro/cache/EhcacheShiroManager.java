...
package com.aojiaoo.core.shiro.cache;

import com.aojiaoo.utils.ResourceUtil;
...
public class EhcacheShiroManager implements CacheManager, Initializable, Destroyable {
    ...
    public void setCacheConfiguration(XmlConfiguration xmlConfiguration) {
        this.cacheConfiguration = xmlConfiguration;
    }
    ...
    private URL getResource() throws MalformedURLException {
        try {
            return ResourceUtil.getURL(cacheManagerConfigFile);
