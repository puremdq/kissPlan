 ...
 */
@Configuration
public class DelegatingWebSocketMessageBrokerConfiguration extends
    ...
    public WebSocketHandler subProtocolWebSocketHandler() {
        return new com.aojiaoo.core.socket.SubProtocolWebSocketHandler(clientInboundChannel(), clientOutboundChannel());
    }
